...
# validdir = os.path.join(data_dir, 'val')
    ...
    train_data = dset.ImageNet("../ImageNetFolder/", split="train",
                                      transform=transforms.Compose([transforms.RandomResizedCrop(224),
                                                                    ...
                                                                    transforms.ToTensor(),
                                                                    normalize, ]))
    valid_data  = dset.ImageNet("../ImageNetFolder/", split="val",
...
#    scheduler = torch.optim.lr_scheduler.StepLR(optimizer, args.decay_period, gamma=args.gamma)
    ...
    for epoch in range(args.epochs):
        ...
        logging.info(' top best Valid_acc_top1: %f Valid_acc_top5: %f', best_acc_top1, best_acc_top5)
